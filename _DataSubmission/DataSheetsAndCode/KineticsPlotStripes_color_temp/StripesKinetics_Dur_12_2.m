...
function StripesKinetics_Dur_12_2(titulo)
...
for i = 1:length(F)
    ...
    elseif isequal(folder,'eveS1Null-eveS2wt')
        ...
        %eveS1Null_eveS2wt_bin = compiledResults.groupID_index;
    ...
    elseif isequal(folder,'eveS1wt-eveS2Gt')
        ...
        %eveS1wt_eveS2Gt_bin = compiledResults.groupID_index;
    ...
    elseif isequal(folder,'eveS1wt-eveS2wt')
        ...
        %eveS1wt_eveS2wt_bin = compiledResults.groupID_index;
    end
...
%     end
    ...
    if isequal(titulo, 'eveS1\Delta-eveS2Gt')
        if unique_stripes(k) == 2
            ...
            fprintf('\n koff'); genotype_koff(strInd) %duration
    ...
    p = plot(genotype_fluo_mean(strInd), genotype_koff(strInd), 'color', strColor, 'LineWidth', linewidth, 'LineStyle', lineShape, 'Marker', 'o');    
    p.MarkerSize = 6;
