...
function StripesKinetics_Int_12_2(titulo)
...
%     end
    ...
    if isequal(titulo, 'eveS1\Delta-eveS2Gt')
        if unique_stripes(k) == 2
            ...
            fprintf('\n r'); genotype_int(strInd) %intensity
    ...
    p = plot(genotype_fluo_mean(strInd), genotype_int(strInd), 'color', strColor, 'LineWidth', linewidth, 'LineStyle', lineShape, 'Marker', 'o');
    p.MarkerSize = 6;
...
if isequal(titulo, 'eveS1\Delta-eveS2Gt')
    legend([l3, l4], {'eveS1-2','eveS2'},...
        'Location', 'none', ...
        'Position',[0.800391220456647 0.086230876216967 0.143874641751971 0.063745938839047],...
        'FontSize', 10);
    legend('boxoff')
end
