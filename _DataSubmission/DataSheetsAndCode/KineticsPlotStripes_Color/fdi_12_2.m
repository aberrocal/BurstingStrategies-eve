...
StripesKinetics_Freq_12_2(titulo1)

nexttile

StripesKinetics_Dur_12_2(titulo1)

nexttile

StripesKinetics_Int_12_2(titulo1)

%%%
nexttile

StripesKinetics_Freq_12_2(titulo2)

nexttile

StripesKinetics_Dur_12_2(titulo2)

nexttile

StripesKinetics_Int_12_2(titulo2)

%%%
nexttile

StripesKinetics_Freq_12_2(titulo3)

nexttile

StripesKinetics_Dur_12_2(titulo3)

nexttile

StripesKinetics_Int_12_2(titulo3)

%%%
nexttile

StripesKinetics_Freq_12_2(titulo4)

nexttile

StripesKinetics_Dur_12_2(titulo4)

nexttile

StripesKinetics_Int_12_2(titulo4)

print(gcf,'fdi_color_12_2.png','-dpng','-r800'); 
%saveas(gcf,'./fdi.tif')
