...
function StripesKinetics_Int_0_2(titulo)
...
unique_stripes = unique_stripes_all(unique_stripes_all < 3);
...
l1 = plot(NaN,NaN, es0shape, 'LineWidth', 4, 'Color', es0color);
l2 = plot(NaN,NaN, es1shape, 'LineWidth', 2, 'Color', es1color);
l3 = plot(NaN,NaN, es15shape, 'LineWidth', 4, 'Color', es15color);
l4 = plot(NaN,NaN, es2shape, 'LineWidth', 2, 'Color', es2color);
% l5 = plot(NaN,NaN, es3shape, 'LineWidth', 2, 'Color', es3color);
% l6 = plot(NaN,NaN, es4shape, 'LineWidth', 2, 'Color', es4color);
...
if isequal(titulo, 'eveS1\Delta-eveS2Gt')
    legend([l1, l2, l3, l4], {'eveS0','eveS1',...
        'eveS1-2','eveS2'},...
        'Location', 'none', ...
        'Position',[0.813724007706139 0.075567917534749 0.14496545098332 0.096893834899187],...
        'FontSize', 8);
    legend('boxoff')
end
